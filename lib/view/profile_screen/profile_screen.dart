...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _openGithub() async {
    ...
    String dt = 'https://github.com/Prashant-ranjan-singh-123/flutter-Unwrapped';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: Colors.black
                                .withOpacity(0.4), // Adjust opacity if needed
                            blurRadius:
                                30, // Increase blurRadius for a softer shadow
                            spreadRadius:
                                10, // Increase spreadRadius for a wider shadow
                            offset: const Offset(0, 10),
                          )
                        ],
                      ),
                      clipBehavior: Clip
                          .antiAlias, // Ensure the border is rendered outside the circle
                      child: Container(
                        width: 154, // Width + 2 * border width
                        height: 154, // Height + 2 * border width
                        decoration: BoxDecoration(
                          ...
                          color: HexColor('#011f4b').withOpacity(
                              0), // Change to the desired background color
                        ),
                        clipBehavior: Clip
                            .antiAlias, // Ensure the border is rendered outside the circle
                        child: Image.asset(
                  ...
                  WidgetCards(context, 10, 10, 0, 0, 'Owner Name',
                      'Prashant Ranjan Singh', null),
                  // SizedBox(height: 0.5,),
                  WidgetCards(context, 0, 0, 0, 0, 'Owner Country', 'India',
                      Image.asset('assets/images/india_flag.jpg')),
                  // SizedBox(height: 0.5,),
                  ...
                  // SizedBox(height: 0.5,),
                  WidgetCards(
                      context, 0, 0, 0, 0, 'Can we Copy Code', 'Yes', null),
                  // SizedBox(height: 0.5,),
                  WidgetCards(
                      context, 0, 0, 10, 10, 'Beginners Friendly', 'Yes', null),
                  // SizedBox(height: 30,),
                  // SizedBox(height: 30,),
                  ...
                  GestureDetector(
                      child: settingsCardWidget(
                        context,
                        title: 'Rate On Playstore',
                        trailing: Image.asset('assets/images/playstore.png'),
                      ),
                      onTap: () {
                        _openPlayStore();
                      }),
